...
<div id="links">
    ...
    <dl>
        ...
        <dd><a href='<?= $actionLinks[Page::ADD_ESSENCE_THING_LINK] ?>'>Добавить экземпляр к сущности</a></dd>
        <dd><a href='<?= $actionLinks[Page::REMOVE_ESSENCE_THING_LINK] ?>'>Удалить экземпляр из сущности</a></dd>
        <dd><a href='<?= $actionLinks[Page::VIEW_THINGS_OF_ESSENCE] ?>'>Показать экземпляры сущности</a></dd>
    </dl>
